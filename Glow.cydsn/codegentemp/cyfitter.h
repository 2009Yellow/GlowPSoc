...
/* PGA_BOTTOM_GND_SC */
#define PGA_BOTTOM_GND_SC__BST CYREG_SC3_BST
#define PGA_BOTTOM_GND_SC__CLK CYREG_SC3_CLK
#define PGA_BOTTOM_GND_SC__CMPINV CYREG_SC_CMPINV
#define PGA_BOTTOM_GND_SC__CPTR CYREG_SC_CPTR
#define PGA_BOTTOM_GND_SC__CR0 CYREG_SC3_CR0
#define PGA_BOTTOM_GND_SC__CR1 CYREG_SC3_CR1
#define PGA_BOTTOM_GND_SC__CR2 CYREG_SC3_CR2
#define PGA_BOTTOM_GND_SC__MSK CYREG_SC_MSK
#define PGA_BOTTOM_GND_SC__PM_ACT_CFG CYREG_PM_ACT_CFG9
#define PGA_BOTTOM_GND_SC__PM_ACT_MSK 0x08u
#define PGA_BOTTOM_GND_SC__PM_STBY_CFG CYREG_PM_STBY_CFG9
#define PGA_BOTTOM_GND_SC__PM_STBY_MSK 0x08u
#define PGA_BOTTOM_GND_SC__SR CYREG_SC_SR
#define PGA_BOTTOM_GND_SC__SW0 CYREG_SC3_SW0
#define PGA_BOTTOM_GND_SC__SW10 CYREG_SC3_SW10
#define PGA_BOTTOM_GND_SC__SW2 CYREG_SC3_SW2
#define PGA_BOTTOM_GND_SC__SW3 CYREG_SC3_SW3
#define PGA_BOTTOM_GND_SC__SW4 CYREG_SC3_SW4
#define PGA_BOTTOM_GND_SC__SW6 CYREG_SC3_SW6
#define PGA_BOTTOM_GND_SC__SW7 CYREG_SC3_SW7
#define PGA_BOTTOM_GND_SC__SW8 CYREG_SC3_SW8
#define PGA_BOTTOM_GND_SC__WRK1 CYREG_SC_WRK1
...
/* IDAC8_REF_viDAC8 */
#define IDAC8_REF_viDAC8__CR0 CYREG_DAC3_CR0
#define IDAC8_REF_viDAC8__CR1 CYREG_DAC3_CR1
#define IDAC8_REF_viDAC8__D CYREG_DAC3_D
#define IDAC8_REF_viDAC8__PM_ACT_CFG CYREG_PM_ACT_CFG8
#define IDAC8_REF_viDAC8__PM_ACT_MSK 0x08u
#define IDAC8_REF_viDAC8__PM_STBY_CFG CYREG_PM_STBY_CFG8
#define IDAC8_REF_viDAC8__PM_STBY_MSK 0x08u
#define IDAC8_REF_viDAC8__STROBE CYREG_DAC3_STROBE
#define IDAC8_REF_viDAC8__SW0 CYREG_DAC3_SW0
#define IDAC8_REF_viDAC8__SW2 CYREG_DAC3_SW2
#define IDAC8_REF_viDAC8__SW3 CYREG_DAC3_SW3
#define IDAC8_REF_viDAC8__SW4 CYREG_DAC3_SW4
#define IDAC8_REF_viDAC8__TR CYREG_DAC3_TR
#define IDAC8_REF_viDAC8__TRIM__M1 CYREG_FLSHID_CUST_TABLES_DAC3_M1
#define IDAC8_REF_viDAC8__TRIM__M2 CYREG_FLSHID_CUST_TABLES_DAC3_M2
#define IDAC8_REF_viDAC8__TRIM__M3 CYREG_FLSHID_CUST_TABLES_DAC3_M3
#define IDAC8_REF_viDAC8__TRIM__M4 CYREG_FLSHID_CUST_TABLES_DAC3_M4
#define IDAC8_REF_viDAC8__TRIM__M5 CYREG_FLSHID_CUST_TABLES_DAC3_M5
#define IDAC8_REF_viDAC8__TRIM__M6 CYREG_FLSHID_CUST_TABLES_DAC3_M6
#define IDAC8_REF_viDAC8__TRIM__M7 CYREG_FLSHID_CUST_TABLES_DAC3_M7
#define IDAC8_REF_viDAC8__TRIM__M8 CYREG_FLSHID_CUST_TABLES_DAC3_M8
#define IDAC8_REF_viDAC8__TST CYREG_DAC3_TST

/* VDAC8_REF_viDAC8 */
#define VDAC8_REF_viDAC8__CR0 CYREG_DAC0_CR0
#define VDAC8_REF_viDAC8__CR1 CYREG_DAC0_CR1
#define VDAC8_REF_viDAC8__D CYREG_DAC0_D
#define VDAC8_REF_viDAC8__PM_ACT_CFG CYREG_PM_ACT_CFG8
#define VDAC8_REF_viDAC8__PM_ACT_MSK 0x01u
#define VDAC8_REF_viDAC8__PM_STBY_CFG CYREG_PM_STBY_CFG8
#define VDAC8_REF_viDAC8__PM_STBY_MSK 0x01u
#define VDAC8_REF_viDAC8__STROBE CYREG_DAC0_STROBE
#define VDAC8_REF_viDAC8__SW0 CYREG_DAC0_SW0
#define VDAC8_REF_viDAC8__SW2 CYREG_DAC0_SW2
#define VDAC8_REF_viDAC8__SW3 CYREG_DAC0_SW3
#define VDAC8_REF_viDAC8__SW4 CYREG_DAC0_SW4
#define VDAC8_REF_viDAC8__TR CYREG_DAC0_TR
#define VDAC8_REF_viDAC8__TRIM__M1 CYREG_FLSHID_CUST_TABLES_DAC0_M1
#define VDAC8_REF_viDAC8__TRIM__M2 CYREG_FLSHID_CUST_TABLES_DAC0_M2
#define VDAC8_REF_viDAC8__TRIM__M3 CYREG_FLSHID_CUST_TABLES_DAC0_M3
#define VDAC8_REF_viDAC8__TRIM__M4 CYREG_FLSHID_CUST_TABLES_DAC0_M4
#define VDAC8_REF_viDAC8__TRIM__M5 CYREG_FLSHID_CUST_TABLES_DAC0_M5
#define VDAC8_REF_viDAC8__TRIM__M6 CYREG_FLSHID_CUST_TABLES_DAC0_M6
#define VDAC8_REF_viDAC8__TRIM__M7 CYREG_FLSHID_CUST_TABLES_DAC0_M7
#define VDAC8_REF_viDAC8__TRIM__M8 CYREG_FLSHID_CUST_TABLES_DAC0_M8
#define VDAC8_REF_viDAC8__TST CYREG_DAC0_TST

/* PGA_TOP_GND_SC */
#define PGA_TOP_GND_SC__BST CYREG_SC0_BST
#define PGA_TOP_GND_SC__CLK CYREG_SC0_CLK
#define PGA_TOP_GND_SC__CMPINV CYREG_SC_CMPINV
#define PGA_TOP_GND_SC__CPTR CYREG_SC_CPTR
#define PGA_TOP_GND_SC__CR0 CYREG_SC0_CR0
#define PGA_TOP_GND_SC__CR1 CYREG_SC0_CR1
#define PGA_TOP_GND_SC__CR2 CYREG_SC0_CR2
#define PGA_TOP_GND_SC__MSK CYREG_SC_MSK
#define PGA_TOP_GND_SC__PM_ACT_CFG CYREG_PM_ACT_CFG9
#define PGA_TOP_GND_SC__PM_ACT_MSK 0x01u
#define PGA_TOP_GND_SC__PM_STBY_CFG CYREG_PM_STBY_CFG9
#define PGA_TOP_GND_SC__PM_STBY_MSK 0x01u
#define PGA_TOP_GND_SC__SR CYREG_SC_SR
#define PGA_TOP_GND_SC__SW0 CYREG_SC0_SW0
#define PGA_TOP_GND_SC__SW10 CYREG_SC0_SW10
#define PGA_TOP_GND_SC__SW2 CYREG_SC0_SW2
#define PGA_TOP_GND_SC__SW3 CYREG_SC0_SW3
#define PGA_TOP_GND_SC__SW4 CYREG_SC0_SW4
#define PGA_TOP_GND_SC__SW6 CYREG_SC0_SW6
#define PGA_TOP_GND_SC__SW7 CYREG_SC0_SW7
#define PGA_TOP_GND_SC__SW8 CYREG_SC0_SW8
#define PGA_TOP_GND_SC__WRK1 CYREG_SC_WRK1
...
/* BOTTOM_1 */
#define BOTTOM_1__0__MASK 0x01u
#define BOTTOM_1__0__PC CYREG_PRT3_PC0
#define BOTTOM_1__0__PORT 3
#define BOTTOM_1__0__SHIFT 0
#define BOTTOM_1__AG CYREG_PRT3_AG
#define BOTTOM_1__AMUX CYREG_PRT3_AMUX
#define BOTTOM_1__BIE CYREG_PRT3_BIE
#define BOTTOM_1__BIT_MASK CYREG_PRT3_BIT_MASK
#define BOTTOM_1__BYP CYREG_PRT3_BYP
#define BOTTOM_1__CTL CYREG_PRT3_CTL
#define BOTTOM_1__DM0 CYREG_PRT3_DM0
#define BOTTOM_1__DM1 CYREG_PRT3_DM1
#define BOTTOM_1__DM2 CYREG_PRT3_DM2
#define BOTTOM_1__DR CYREG_PRT3_DR
#define BOTTOM_1__INP_DIS CYREG_PRT3_INP_DIS
#define BOTTOM_1__LCD_COM_SEG CYREG_PRT3_LCD_COM_SEG
#define BOTTOM_1__LCD_EN CYREG_PRT3_LCD_EN
#define BOTTOM_1__MASK 0x01u
#define BOTTOM_1__PORT 3
#define BOTTOM_1__PRT CYREG_PRT3_PRT
#define BOTTOM_1__PRTDSI__CAPS_SEL CYREG_PRT3_CAPS_SEL
#define BOTTOM_1__PRTDSI__DBL_SYNC_IN CYREG_PRT3_DBL_SYNC_IN
#define BOTTOM_1__PRTDSI__OE_SEL0 CYREG_PRT3_OE_SEL0
#define BOTTOM_1__PRTDSI__OE_SEL1 CYREG_PRT3_OE_SEL1
#define BOTTOM_1__PRTDSI__OUT_SEL0 CYREG_PRT3_OUT_SEL0
#define BOTTOM_1__PRTDSI__OUT_SEL1 CYREG_PRT3_OUT_SEL1
#define BOTTOM_1__PRTDSI__SYNC_OUT CYREG_PRT3_SYNC_OUT
#define BOTTOM_1__PS CYREG_PRT3_PS
#define BOTTOM_1__SHIFT 0
#define BOTTOM_1__SLW CYREG_PRT3_SLW

/* BOTTOM_2 */
#define BOTTOM_2__0__MASK 0x02u
#define BOTTOM_2__0__PC CYREG_PRT3_PC1
#define BOTTOM_2__0__PORT 3
#define BOTTOM_2__0__SHIFT 1
#define BOTTOM_2__AG CYREG_PRT3_AG
#define BOTTOM_2__AMUX CYREG_PRT3_AMUX
#define BOTTOM_2__BIE CYREG_PRT3_BIE
#define BOTTOM_2__BIT_MASK CYREG_PRT3_BIT_MASK
#define BOTTOM_2__BYP CYREG_PRT3_BYP
#define BOTTOM_2__CTL CYREG_PRT3_CTL
#define BOTTOM_2__DM0 CYREG_PRT3_DM0
#define BOTTOM_2__DM1 CYREG_PRT3_DM1
#define BOTTOM_2__DM2 CYREG_PRT3_DM2
#define BOTTOM_2__DR CYREG_PRT3_DR
#define BOTTOM_2__INP_DIS CYREG_PRT3_INP_DIS
#define BOTTOM_2__LCD_COM_SEG CYREG_PRT3_LCD_COM_SEG
#define BOTTOM_2__LCD_EN CYREG_PRT3_LCD_EN
#define BOTTOM_2__MASK 0x02u
#define BOTTOM_2__PORT 3
#define BOTTOM_2__PRT CYREG_PRT3_PRT
#define BOTTOM_2__PRTDSI__CAPS_SEL CYREG_PRT3_CAPS_SEL
#define BOTTOM_2__PRTDSI__DBL_SYNC_IN CYREG_PRT3_DBL_SYNC_IN
#define BOTTOM_2__PRTDSI__OE_SEL0 CYREG_PRT3_OE_SEL0
#define BOTTOM_2__PRTDSI__OE_SEL1 CYREG_PRT3_OE_SEL1
#define BOTTOM_2__PRTDSI__OUT_SEL0 CYREG_PRT3_OUT_SEL0
#define BOTTOM_2__PRTDSI__OUT_SEL1 CYREG_PRT3_OUT_SEL1
#define BOTTOM_2__PRTDSI__SYNC_OUT CYREG_PRT3_SYNC_OUT
#define BOTTOM_2__PS CYREG_PRT3_PS
#define BOTTOM_2__SHIFT 1
#define BOTTOM_2__SLW CYREG_PRT3_SLW

/* BOTTOM_3 */
#define BOTTOM_3__0__MASK 0x04u
#define BOTTOM_3__0__PC CYREG_PRT3_PC2
#define BOTTOM_3__0__PORT 3
#define BOTTOM_3__0__SHIFT 2
#define BOTTOM_3__AG CYREG_PRT3_AG
#define BOTTOM_3__AMUX CYREG_PRT3_AMUX
#define BOTTOM_3__BIE CYREG_PRT3_BIE
#define BOTTOM_3__BIT_MASK CYREG_PRT3_BIT_MASK
#define BOTTOM_3__BYP CYREG_PRT3_BYP
#define BOTTOM_3__CTL CYREG_PRT3_CTL
#define BOTTOM_3__DM0 CYREG_PRT3_DM0
#define BOTTOM_3__DM1 CYREG_PRT3_DM1
#define BOTTOM_3__DM2 CYREG_PRT3_DM2
#define BOTTOM_3__DR CYREG_PRT3_DR
#define BOTTOM_3__INP_DIS CYREG_PRT3_INP_DIS
#define BOTTOM_3__LCD_COM_SEG CYREG_PRT3_LCD_COM_SEG
#define BOTTOM_3__LCD_EN CYREG_PRT3_LCD_EN
#define BOTTOM_3__MASK 0x04u
#define BOTTOM_3__PORT 3
#define BOTTOM_3__PRT CYREG_PRT3_PRT
#define BOTTOM_3__PRTDSI__CAPS_SEL CYREG_PRT3_CAPS_SEL
#define BOTTOM_3__PRTDSI__DBL_SYNC_IN CYREG_PRT3_DBL_SYNC_IN
#define BOTTOM_3__PRTDSI__OE_SEL0 CYREG_PRT3_OE_SEL0
#define BOTTOM_3__PRTDSI__OE_SEL1 CYREG_PRT3_OE_SEL1
#define BOTTOM_3__PRTDSI__OUT_SEL0 CYREG_PRT3_OUT_SEL0
#define BOTTOM_3__PRTDSI__OUT_SEL1 CYREG_PRT3_OUT_SEL1
#define BOTTOM_3__PRTDSI__SYNC_OUT CYREG_PRT3_SYNC_OUT
#define BOTTOM_3__PS CYREG_PRT3_PS
#define BOTTOM_3__SHIFT 2
#define BOTTOM_3__SLW CYREG_PRT3_SLW

/* BOTTOM_4 */
#define BOTTOM_4__0__MASK 0x08u
#define BOTTOM_4__0__PC CYREG_PRT3_PC3
#define BOTTOM_4__0__PORT 3
#define BOTTOM_4__0__SHIFT 3
#define BOTTOM_4__AG CYREG_PRT3_AG
#define BOTTOM_4__AMUX CYREG_PRT3_AMUX
#define BOTTOM_4__BIE CYREG_PRT3_BIE
#define BOTTOM_4__BIT_MASK CYREG_PRT3_BIT_MASK
#define BOTTOM_4__BYP CYREG_PRT3_BYP
#define BOTTOM_4__CTL CYREG_PRT3_CTL
#define BOTTOM_4__DM0 CYREG_PRT3_DM0
#define BOTTOM_4__DM1 CYREG_PRT3_DM1
#define BOTTOM_4__DM2 CYREG_PRT3_DM2
#define BOTTOM_4__DR CYREG_PRT3_DR
#define BOTTOM_4__INP_DIS CYREG_PRT3_INP_DIS
#define BOTTOM_4__LCD_COM_SEG CYREG_PRT3_LCD_COM_SEG
#define BOTTOM_4__LCD_EN CYREG_PRT3_LCD_EN
#define BOTTOM_4__MASK 0x08u
#define BOTTOM_4__PORT 3
#define BOTTOM_4__PRT CYREG_PRT3_PRT
#define BOTTOM_4__PRTDSI__CAPS_SEL CYREG_PRT3_CAPS_SEL
#define BOTTOM_4__PRTDSI__DBL_SYNC_IN CYREG_PRT3_DBL_SYNC_IN
#define BOTTOM_4__PRTDSI__OE_SEL0 CYREG_PRT3_OE_SEL0
#define BOTTOM_4__PRTDSI__OE_SEL1 CYREG_PRT3_OE_SEL1
#define BOTTOM_4__PRTDSI__OUT_SEL0 CYREG_PRT3_OUT_SEL0
#define BOTTOM_4__PRTDSI__OUT_SEL1 CYREG_PRT3_OUT_SEL1
#define BOTTOM_4__PRTDSI__SYNC_OUT CYREG_PRT3_SYNC_OUT
#define BOTTOM_4__PS CYREG_PRT3_PS
#define BOTTOM_4__SHIFT 3
#define BOTTOM_4__SLW CYREG_PRT3_SLW
...
/* TOP_1 */
#define TOP_1__0__MASK 0x01u
#define TOP_1__0__PC CYREG_PRT0_PC0
#define TOP_1__0__PORT 0
#define TOP_1__0__SHIFT 0
#define TOP_1__AG CYREG_PRT0_AG
#define TOP_1__AMUX CYREG_PRT0_AMUX
#define TOP_1__BIE CYREG_PRT0_BIE
#define TOP_1__BIT_MASK CYREG_PRT0_BIT_MASK
#define TOP_1__BYP CYREG_PRT0_BYP
#define TOP_1__CTL CYREG_PRT0_CTL
#define TOP_1__DM0 CYREG_PRT0_DM0
#define TOP_1__DM1 CYREG_PRT0_DM1
#define TOP_1__DM2 CYREG_PRT0_DM2
#define TOP_1__DR CYREG_PRT0_DR
#define TOP_1__INP_DIS CYREG_PRT0_INP_DIS
#define TOP_1__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define TOP_1__LCD_EN CYREG_PRT0_LCD_EN
#define TOP_1__MASK 0x01u
#define TOP_1__PORT 0
#define TOP_1__PRT CYREG_PRT0_PRT
#define TOP_1__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define TOP_1__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define TOP_1__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define TOP_1__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define TOP_1__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define TOP_1__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define TOP_1__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define TOP_1__PS CYREG_PRT0_PS
#define TOP_1__SHIFT 0
#define TOP_1__SLW CYREG_PRT0_SLW

/* TOP_2 */
#define TOP_2__0__MASK 0x02u
#define TOP_2__0__PC CYREG_PRT0_PC1
#define TOP_2__0__PORT 0
#define TOP_2__0__SHIFT 1
#define TOP_2__AG CYREG_PRT0_AG
#define TOP_2__AMUX CYREG_PRT0_AMUX
#define TOP_2__BIE CYREG_PRT0_BIE
#define TOP_2__BIT_MASK CYREG_PRT0_BIT_MASK
#define TOP_2__BYP CYREG_PRT0_BYP
#define TOP_2__CTL CYREG_PRT0_CTL
#define TOP_2__DM0 CYREG_PRT0_DM0
#define TOP_2__DM1 CYREG_PRT0_DM1
#define TOP_2__DM2 CYREG_PRT0_DM2
#define TOP_2__DR CYREG_PRT0_DR
#define TOP_2__INP_DIS CYREG_PRT0_INP_DIS
#define TOP_2__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define TOP_2__LCD_EN CYREG_PRT0_LCD_EN
#define TOP_2__MASK 0x02u
#define TOP_2__PORT 0
#define TOP_2__PRT CYREG_PRT0_PRT
#define TOP_2__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define TOP_2__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define TOP_2__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define TOP_2__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define TOP_2__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define TOP_2__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define TOP_2__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define TOP_2__PS CYREG_PRT0_PS
#define TOP_2__SHIFT 1
#define TOP_2__SLW CYREG_PRT0_SLW

/* TOP_3 */
#define TOP_3__0__MASK 0x80u
#define TOP_3__0__PC CYREG_PRT3_PC7
#define TOP_3__0__PORT 3
#define TOP_3__0__SHIFT 7
...
#define TOP_3__SHIFT 7
#define TOP_3__SLW CYREG_PRT3_SLW

/* TOP_4 */
#define TOP_4__0__MASK 0x08u
#define TOP_4__0__PC CYREG_PRT0_PC3
#define TOP_4__0__PORT 0
#define TOP_4__0__SHIFT 3
#define TOP_4__AG CYREG_PRT0_AG
#define TOP_4__AMUX CYREG_PRT0_AMUX
#define TOP_4__BIE CYREG_PRT0_BIE
#define TOP_4__BIT_MASK CYREG_PRT0_BIT_MASK
#define TOP_4__BYP CYREG_PRT0_BYP
#define TOP_4__CTL CYREG_PRT0_CTL
#define TOP_4__DM0 CYREG_PRT0_DM0
#define TOP_4__DM1 CYREG_PRT0_DM1
#define TOP_4__DM2 CYREG_PRT0_DM2
#define TOP_4__DR CYREG_PRT0_DR
#define TOP_4__INP_DIS CYREG_PRT0_INP_DIS
#define TOP_4__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define TOP_4__LCD_EN CYREG_PRT0_LCD_EN
#define TOP_4__MASK 0x08u
#define TOP_4__PORT 0
#define TOP_4__PRT CYREG_PRT0_PRT
#define TOP_4__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define TOP_4__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define TOP_4__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define TOP_4__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define TOP_4__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define TOP_4__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define TOP_4__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define TOP_4__PS CYREG_PRT0_PS
#define TOP_4__SHIFT 3
#define TOP_4__SLW CYREG_PRT0_SLW
